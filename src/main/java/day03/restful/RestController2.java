    ...
    @RestController : +ResponseBody 포함 (해당 클래스내 모든 함수들은 자동으로 @ResponseBody 주입)
        ...
        - 컨트롤러 클래스 안에서 주요 사용되는 어노테이션
            ...
            1-2 XXXMapping
                ...
                @GetMapping("/day03/blue") <=>  @RequestMapping(value = "/day03/blue", method= RequestMethod.GET)
                @PostMapping("/day03/blue") <=>  @RequestMapping(value = "/day03/blue", method= RequestMethod.POST)
                @PutMapping("/day03/blue") <=>  @RequestMapping(value = "/day03/blue", method= RequestMethod.PUT)
                @DeleteMapping("/day03/blue") <=>  @RequestMapping(value = "/day03/blue", method= RequestMethod.DELETE)
